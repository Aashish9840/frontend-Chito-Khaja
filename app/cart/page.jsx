...
const page = () => {
    ...
    return (
        <div className='container px-4 sm:px-0'>
            <Header />
            <div className="flex cursor-pointer items-center mt-6" onClick={() => router.push('/')}>
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 512 512"><path fill="#7b6868" d="M497.333 239.999H80.092l95.995-95.995l-22.627-22.627L18.837 256L153.46 390.623l22.627-22.627l-95.997-95.997h417.243z" /></svg>
                <h1 className='text-base text-gray-500 font-dm_sans font-medium'>Home</h1>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16"><path fill="#7b6868" d="M8 9.5a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3" /></svg>
                <h1 className='text-base text-gray-500 font-dm_sans font-medium'>{singleFood?.category}</h1>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16"><path fill="#7b6868" d="M8 9.5a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3" /></svg>
                <h1 className='text-base text-gray-500 font-dm_sans font-medium'>{singleFood?.name}</h1>
            </div>
